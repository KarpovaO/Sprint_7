...
public class CourierLoginTest extends CourierBaseTest {
    private static final String LOGIN = "ninja"+ LocalDateTime.now().toString();
    private static final String PASSWORD = "1234"+ LocalDateTime.now().toString();
    private static final String FIRSTNAME = "ninja"+ LocalDateTime.now().toString() + "name";
    ...
    @Test
    @DisplayName("Логин курьера") // имя теста
